...
import { Pressable, FlatList, AppState } from 'react-native';
  ...
  useLayoutEffect(() => {
      const right = (
        <View style={style.headerRightContainer}>
          <Pressable activeOpacity={0.85} style={style.inviteButton} onPress={invite}>
            <Iconn name="person-add" color="#fff" size={28} />
          </Pressable>
        </View>
      );
